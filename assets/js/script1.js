var canvas;
        ...
        var ballX=50;
        var ballY=150;
        var moveSpeedHorizontal =20;
        var moveSpeedVertical=20;
        ...
        function computerMovement(){
            var paddle2YCenter = paddle2Y + (PADDLE_HEIGHT/35);
            if(paddle2YCenter > ballY+1)
                {
                    paddle2Y -= 30;
        ...
        function drawNet(){
            for(var i=0;i<=canvas.height;i+=40){
                colorRect(canvas.width/2-1,i,10,25,'white');                     }
        }
		...
		canvasContext.fillRect(10,10,100,100);
            ...
            canvasContext.fillText('Сlick on the square to continue',
                               500,350);
            return;
        }    
        ...
        colorRect(canvas.width-PADDLE_THICKNESS,
                  paddle2Y,PADDLE_THICKNESS,PADDLE_HEIGHT,'red');
